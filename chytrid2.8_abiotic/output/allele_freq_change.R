...
plot(-100,-100, ylim = c(0,240), xlim = c(0.28, 0.56), xlab = "Allele frequency change", ylab = "Final population size")
rect(par("usr")[1],par("usr")[3],par("usr")[2],par("usr")[4],col = "gray")
abline(lm(dat5[which(dat5[, 1] == 1), 3] ~ dat5[which(dat5[, 1] == 1), 6]), lwd = 3)
points(dat5[which(dat5[, 1] == 1), 6], dat5[which(dat5[, 1] == 1), 3], pch = 19, col = "purple", cex = 2)


#deterministic_not_used
#dat5 <- OUT3[order(OUT3[, 6]), ]
#dat5 <- dat5[-which(dat5[, 1] == 0), ]
#dat5 <- dat5[-which(dat5[, 1] == 1), ]
#dat5 <- dat5[-which(dat5[, 1] == 2), ]
#dat5 <- dat5[order(dat5[, 6]), ]
#points(dat5[which(dat5[, 1] == 4), 6], dat5[which(dat5[, 1] == 4), 3], pch = 21, bg = "purple", col="purple4", cex = 2)
...
plot(-100,-100, ylim = c(0,16), xlim = c(0, 0.65), xlab = "Allele frequency change", ylab = "Final population size", yaxt ='n', bty ='n')
rect(par("usr")[1],par("usr")[3],par("usr")[2],par("usr")[4],col = "gray", border = NA)

points(dat5[which(dat5[, 1] == 5), 6], rep(15, length(which(dat5[, 1] == 5))), pch = 19, col = rgb(red = 0, green = 0, blue = 1, alpha = 0.3), cex = 2)
points(median(dat5[which(dat5[, 1] == 5), 6]), rep(15, 1), pch = 21, bg = "blue", cex = 2.5)
text(0.6, 15, "N=6", cex = 1.5)

#col2rgb("purple", alpha = 0.3)
points(dat5[which(dat5[, 1] == 4), 6], rep(14, length(which(dat5[, 1] == 4))), pch = 19, col = rgb(red = 160, green = 32, blue = 240, alpha = 78, max =255), cex = 2)
points(median(dat5[which(dat5[, 1] == 4), 6]), rep(14, 1), pch = 21, bg = "purple", cex = 2.5)
text(0.6, 14, "N=44", cex = 1.5)
...
#col2rgb("orange", alpha = 0.3)
points(dat5[which(dat5[, 1] == 0), 6], rep(11, length(which(dat5[, 1] == 0))), pch = 19, col = rgb(red = 255, green = 165, blue = 0,  alpha = 78, max =255), cex = 2)
points(median(dat5[which(dat5[, 1] == 0), 6]), rep(11, 1), pch = 21, bg = "orange", cex = 2.5)
text(0.6, 11, "N=11", cex = 1.5)

points(dat5[which(dat5[, 1] == 2), 6], rep(10, length(which(dat5[, 1] == 2))), pch = 19, col = rgb(red = 0, green = 0, blue = 1, alpha = 0.3), cex = 2)
points(median(dat5[which(dat5[, 1] == 2), 6]), rep(10, 1), pch = 21, bg = "blue", cex = 2.5)
text(0.6, 10, "N=9", cex = 1.5)

points(dat5[which(dat5[, 1] == 1), 6], rep(9, length(which(dat5[, 1] == 1))), pch = 19, col = rgb(red = 160, green = 32, blue = 240, alpha = 78, max =255), cex = 2)
points(median(dat5[which(dat5[, 1] == 1), 6]), rep(9, 1), pch = 21, bg = "purple", cex = 2.5)
text(0.6, 9, "N=30", cex = 1.5)
...
for(i in ival){
  ...
  category <- 6 # 6 extinct deterministic
...
points(dat5[which(dat5[, 1] == 6), 6], rep(6, length(which(dat5[, 1] == 6))), pch = 19,  col = rgb(red = 255, green = 165, blue = 0,  alpha = 78, max =255), cex = 2)
points(median(dat5[which(dat5[, 1] == 6), 6]), rep(6, 1), pch = 21, bg = "orange", cex = 2.5)
text(0.6, 6, "N=12", cex = 1.5)

#col2rgb("black", alpha = 0.3)
points(dat5[which(dat5[, 1] == 4), 6], rep(5, length(which(dat5[, 1] == 4))), pch = 19, col = rgb(red = 0, green = 0, blue = 0, alpha = 78, max =255), cex = 2)
points(median(dat5[which(dat5[, 1] == 4), 6]), rep(5, 1), pch = 21, bg = "black", cex = 2.5)
text(0.6, 5, "N=38", cex = 1.5)


dat5 <- OUT3[order(OUT3[, 6]), ]
dat5 <- dat5[-which(dat5[, 1] == 4), ]
dat5 <- dat5[-which(dat5[, 1] == 6), ]
dat5 <- dat5[order(dat5[, 6]), ]


points(dat5[which(dat5[, 1] == 0), 6], rep(2, length(which(dat5[, 1] == 0))), pch = 19,  col = rgb(red = 255, green = 165, blue = 0,  alpha = 78, max =255), cex = 2)
points(median(dat5[which(dat5[, 1] == 0), 6]), rep(2, 1), pch = 21, bg = "orange", cex = 2.5)
text(0.6, 2, "N=30", cex = 1.5)

#col2rgb("black", alpha = 0.3)
points(dat5[which(dat5[, 1] == 1), 6], rep(1, length(which(dat5[, 1] == 1))), pch = 19, col = rgb(red = 0, green = 0, blue = 0, alpha = 78, max =255), cex = 2)
points(median(dat5[which(dat5[, 1] == 1), 6]), rep(1, 1), pch = 21, bg = "black", cex = 2.5)
text(0.6, 1, "N=20", cex = 1.5)
